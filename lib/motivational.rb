...
class Motivational
  ...
  def initialize
    @motivational_quotes = ['Do not be pushed around by the fears in your mind. Be led by the dreams in your heart. ― Roy T. Bennett',
  ...
  def random_motivational
    PickOne.rand_string(@motivational_quotes)
  end
end
